...
import { FontFamily, FontSize, FontWeight, LineHeight, TypographySystem, DefaultFontFamily, DefaultFontSize, DefaultFontWeight, DefaultLineHeight } from './typography';
...
export type ThemeScalesOptions = MergeDefault<ThemeScales, {
